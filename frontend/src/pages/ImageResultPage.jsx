...
// 💡 Importation de la variable d'environnement VITE
// Assurez-vous d'avoir VITE_API_BASE_URL=http://127.0.0.1:8000 dans votre fichier .env
...
const ImageResultPage = () => {
    ...
    useEffect(() => {
        if (location.state && location.state.matching_recipes) {
            setRecipes(location.state.matching_recipes);
        } else {
            console.error('❌ Aucune recette trouvée dans location.state');
        }
        setLoading(false);
    }, [location]);
                ...
                <section className="recipes-section">
                    ...
                    {recipes.length > 0 ? (
                            ...
                            {recipes.map((recipe, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* 🎯 NOUVELLE STRUCTURE : IMAGE EN HAUT */}
                                        {imageUrl && (
                                        ...
                                        <div className="recipe-content"> 
                                            ...
                                            {/* Ingrédients principaux (affichage compact) */}
                        ...
                        <div className="no-results">
                            ...
                            <p>Essayez avec une autre image ou affinez votre recherche</p>
